...
function TournamentRecapDialog(props) {
    ...
    const isRecapDialogOpen = useSelector((state) => state.uiState.isRecapDialogOpen);
    ...
    const championObj = useSelector((state) => state.tournament.champion.champion[0][0]);
    const playerPickChampion = useSelector((state) => state.tournamentPlayersPicks.picks.champion.champion[0][0].team)
    ...
    const championPrimaryColor = teamStatsObject[champConf][championObj.team]["primary-color"];
    ...
    return (
        ...
        >
            <h3 className="text-center" style={{color: ACCENT_COLOR}}>We Have a New Champ</h3>
            <div className="flex flex-col justify-start items-center gap-4">
                ...
                >
                    <Image src={championLogo} alt="Champion's Logo" width={200} height={200} />
                </div>
            </div>
